...
function preload() {
  ...
  //Preload instructions audio
  instructions = loadSound('assets/instructions.mp3');
  //Preload images
  single = loadImage('assets/single.png');
  yellowPlay = loadImage('assets/yellow_play.png');
  yellowDownload = loadImage('assets/yellow_download.png');
  playInstructionsButton = loadImage('assets/play_button.png');
  ...
  vm13 = loadSound('assets/voicemails/VM_13.mp3');
  vm14 = loadSound('assets/voicemails/VM_14.mp3');
  vm15 = loadSound('assets/voicemails/VM_15.mp3');
  vm16 = loadSound('assets/voicemails/VM_16.mp3');
  vm17 = loadSound('assets/voicemails/VM_17.mp3');
...
function setup() {
  ...
  yellowPlay.resize(targetSize, targetSize);
  yellowDownload.resize(targetSize, targetSize);
  playInstructionsButton.resize(targetSize, targetSize);
  ...
  //If a file contains a clickable voicemail, it is loaded grey
    ...
    for (let i = 0; i < width; i += targetSize) {
      for (let j = 0; j < height; j += targetSize) {
        ...
        //++++++++ i = X, j = Y ++++++++++
        //++++++++ 900, 400 is 10th column, 5th row  ++++++++++

        //Playable files
        if ((i == 400 && j == 0) || (i == 500 && j == 0) || (i == 700 && j == 0)
          || (i == 100 && j == 100) || (i == 300 && j == 100) || (i == 1100 && j == 200)
          || (i == 600 && j == 300) || (i == 100 && j == 400) || (i == 400 && j == 400)
          || (i == 900 && j == 400) || (i == 200 && j == 200) || (i == 700 && j == 500)
          || (i == 1200 && j == 0) || (i == 1000 && j == 300) || (i == 1100 && j == 500)
          || (i == 900 && j == 200) || (i == 0 && j == 500)) {
          image(yellowPlay, i, j);
    ...
    image(playInstructionsButton, width - 300, height - 200);
    image(border, width - 405, height - 345);
...
function mouseClicked() {
  ...
  //A second click stops it
    ...
    if (mouseX >= 425 && mouseX <= 472 && mouseY >= 10 && mouseY <= 70) {
      ...
      //Voicemail 13
    } else if (mouseX >= 1225 && mouseX <= 1272 && mouseY >= 10 && mouseY <= 70) {
      if (clickVM13 == 0) {
        vm13.play();
        clickVM13 = 1;
      } else {
      ...
      //Voicemail 14
    } else if (mouseX >= 1025 && mouseX <= 1072 && mouseY >= 310 && mouseY <= 370) {
      if (clickVM14 == 0) {
        vm14.play();
        clickVM14 = 1;
      } else {
      ...
      //Voicemail 15
    } else if (mouseX >= 1125 && mouseX <= 1172 && mouseY >= 510 && mouseY <= 570) {
      if (clickVM15 == 0) {
        vm15.play();
        clickVM15 = 1;
      } else {
      ...
      //Voicemail 16
    } else if (mouseX >= 925 && mouseX <= 972 && mouseY >= 210 && mouseY <= 270) {
      if (clickVM16 == 0) {
        vm16.play();
        clickVM16 = 1;
      } else {
      ...
      //Voicemail 17
    } else if (mouseX >= 25 && mouseX <= 72 && mouseY >= 510 && mouseY <= 570) {
      if (clickVM17 == 0) {
        vm17.play();
        clickVM17 = 1;
      } else {
      ...
      //Instructions play/stop
    } else if (mouseX > (width - 300) + 20 && mouseX < (width - 300) + 97
      && mouseY > (height - 200) + 11 && mouseY < (height - 200) + 90) {
      if (clickInstructions == 0) {
        instructions.play();
        clickInstructions = 1;
      } else {
        instructions.stop();
